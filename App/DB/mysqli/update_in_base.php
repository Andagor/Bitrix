...
// echo "conn-prepare<br>";
// echo '<pre>'; print_r($conn->error); echo '</pre>';
// echo '<pre>'; print_r($sql); echo '</pre>';
// echo "Перед bind_param<br>";
/* Подготовленный запрос, шаг 2: связывание и выполнение */
// file_put_contents('Applog.log', print_r($conn->error, true), FILE_APPEND);
...
// echo '<pre>'; print_r($sql); echo '</pre>';
        ...
        echo "in Update_in_Base function after add data<br>";
        echo '<pre>'; print_r($sql); echo '</pre>';
        // if ($conn->query($sql))
        if ($sql->execute())
        {
